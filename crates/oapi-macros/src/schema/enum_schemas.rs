            ...
            #[cfg(feature = "repr")]
            {
                attributes
                    ...
                    .map(|enum_type| {
                        ...
                        let description = pop_feature!(repr_enum_features => Feature::Description(_)).into_inner();
                        Ok(Self {
                    ...
                    .unwrap_or_else(|| {
                        ...
                        let description = pop_feature!(simple_enum_features => Feature::Description(_)).into_inner();
                        Ok(Self {
