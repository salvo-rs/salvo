...
mod tests {
    ...
    async fn test_de_request_from_query() {
        ...
        #[salvo(default_source(from = "query"))]
        struct RequestData {
            q1: String,
            q2: i64,
        }
    ...
    async fn test_de_request_with_lifetime() {
        ...
        struct RequestData<'a> {
            #[salvo(source(from = "param"), source(from = "query"))]
            #[salvo(source(from = "body"))]
            q1: &'a str,
    ...
    async fn test_de_request_with_rename() {
        ...
        #[salvo(default_source(from = "query"))]
        struct RequestData<'a> {
            #[salvo(source(from = "param"), source(from = "query"), rename = "abc")]
            q1: &'a str,
        }
    ...
    async fn test_de_request_with_rename_all() {
        #[derive(Deserialize, Extractible, Eq, PartialEq, Debug)]
        #[salvo(default_source(from = "query"), rename_all = "PascalCase")]
        struct RequestData<'a> {
            first_name: &'a str,
            #[salvo(rename = "lastName")]
            last_name: &'a str,
        }
    ...
    async fn test_de_request_with_multi_sources() {
        ...
        struct RequestData<'a> {
            ...
            #[salvo(alias = "param1")]
            p1: String,
            #[salvo(source(from = "param"), alias = "param2")]
            p2: &'a str,
            #[salvo(source(from = "param"), alias = "param3")]
            p3: usize,
            // #[salvo(source(from = "query"))]
            q1: String,
            // #[salvo(source(from = "query"))]
            q2: i64,
            // #[salvo(source(from = "body", format = "json"))]
            // body: RequestBody<'a>,
        }
