...
impl TlsServer {
    ...
    pub fn key_path(self, path: impl AsRef<Path>) -> Self {
        self.with_tls(|tls| tls.with_key_path(path))
    }
    ...
    pub fn cert_path(self, path: impl AsRef<Path>) -> Self {
        self.with_tls(|tls| tls.with_cert_path(path))
    }
    ...
    pub fn client_auth_optional_path(self, path: impl AsRef<Path>) -> Self {
        self.with_tls(|tls| tls.with_client_auth_optional_path(path))
    }
    ...
    pub fn client_auth_required_path(self, path: impl AsRef<Path>) -> Self {
        self.with_tls(|tls| tls.with_client_auth_required_path(path))
    }
    ...
    pub fn key(self, key: impl AsRef<[u8]>) -> Self {
        self.with_tls(|tls| tls.with_key(key.as_ref()))
    }
    ...
    pub fn cert(self, cert: impl AsRef<[u8]>) -> Self {
        self.with_tls(|tls| tls.with_cert(cert.as_ref()))
    }
    ...
    pub fn client_auth_optional(self, trust_anchor: impl AsRef<[u8]>) -> Self {
        self.with_tls(|tls| tls.with_client_auth_optional(trust_anchor.as_ref()))
    }
    ...
    pub fn client_auth_required(self, trust_anchor: impl AsRef<[u8]>) -> Self {
        self.with_tls(|tls| tls.with_client_auth_required(trust_anchor.as_ref()))
    }
    ...
    pub fn ocsp_resp(self, resp: impl AsRef<[u8]>) -> Self {
        self.with_tls(|tls| tls.with_ocsp_resp(resp.as_ref()))
    }
