...
pub mod tests {
    ...
    async fn test_06_test_create_users_route_failure_user_already_exist() {
        ...
        let response: ErrorResponseModel =
    ...
    async fn test_09_test_protected_users_me_failure() {
        ...
        let error: ErrorResponseModel = response.take_json().await.expect("Failed to parse JSON");
    ...
    async fn test_12_test_users_update_success() {
        ...
        let user_update: UserSuccessResponseModel =
            response.take_json().await.expect("Failed to parse JSON");
    ...
    async fn test_14_test_users_delete_success() {
        ...
        let user_delete: UserSuccessResponseModel =
            response.take_json().await.expect("Failed to parse JSON");
